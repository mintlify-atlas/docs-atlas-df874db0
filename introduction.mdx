...
import { StaticTrackSource, MemoryObjectCache } from 'moqtail/client'
...
import { HybridTrackSource } from 'moqtail/client'

// Combines live streaming with historical data access
const hybridSource = new HybridTrackSource(objectStream, cache)
```
</CodeGroup>
